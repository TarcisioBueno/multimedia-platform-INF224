...
Fonctionnalités disponibles \+: \char`\"{}\+Rechercher\char`\"{}, \char`\"{}\+Jouer\char`\"{}, \char`\"{}\+Finaliser\char`\"{} et \char`\"{}\+Lister\char`\"{}.

Pour utiliser ces fonctionnalités, saisissez le média que vous souhaitez rechercher ou jouer. Ensuite, appuyez sur le bouton correspondant à l\textquotesingle{}action que vous souhaitez effectuer \+: \char`\"{}\+Rechercher\char`\"{} ou \char`\"{}\+Jouer\char`\"{}.
